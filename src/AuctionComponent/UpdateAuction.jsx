  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      const api = await fetch(
        `https://deploy-realestate.onrender.com/api/updateAuctionListing/${params.id}`,
        {
          method: "PUT",
      ...
      navigate(
        `https://deploy-realestate.onrender.com/auctionDetails/auctionSingleListing/${data._id}`
      );
    } catch (error) {
