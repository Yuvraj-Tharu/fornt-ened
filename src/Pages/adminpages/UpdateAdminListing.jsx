  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      const api = await fetch(
        `https://deploy-realestate.onrender.com/api/updateAdminListing/${params.id}`,
        {
          method: "PUT",
      ...
      navigate(
        `https://deploy-realestate.onrender.com/admin-showSingleListing/${data._id}`
      );
    } catch (error) {
  ...
  const displayListing = async () => {
    try {
      let result = await fetch(
        `https://deploy-realestate.onrender.com/api/getAdminListing/${params.id}`
      );
